...
public class LibroTreeSet implements Comparable<LibroTreeSet> {
	...
	public LibroTreeSet(String titulo, Persona autor, String isbn, int paginas, int edicion, 
	...
	public int compareTo(LibroTreeSet l) {
		return (titulo.compareToIgnoreCase(l.titulo));
	}
